...
public class InitList
{
    ...
    public static void init()
    {
        ...
        xfMenuList.setBounds(new int[]{
                XFMenuList.getButtonPoint(MainWindow.getMainWindow(), MainContainerPage_3.getMainContainerPanelLeftTopFileButton())[0],
                XFMenuList.getButtonPoint(MainWindow.getMainWindow(), MainContainerPage_3.getMainContainerPanelLeftTopFileButton())[1],
                400, 200});
        ...
        xfMenuList.addButtonClicked(new ButtonClick()
        {
            ...
            public void clicked(MouseEvent event)
            {
                ...
                SetFile.start(file);
                WriteMinecraftToJMCI.jmciFile = new File(file.toString());
            }
        });
        xfMenuList.show();
    }
